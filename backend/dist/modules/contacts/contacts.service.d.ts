...
export declare class ContactsService {
    ...
    upsert(orgId: string, dto: CreateContactDto): Promise<{
        id: string;
        email: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    importCsv(orgId: string, listId: string, file: Express.Multer.File): Promise<import("bull").Job<any>>;
    unsubscribe(email: string, orgId: string): Promise<{
        message: string;
    }>;
