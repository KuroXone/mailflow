...
let AutomationController = class AutomationController {
    ...
    activate(id, orgId) { return this.svc.activate(id, orgId); }
    pause(id, orgId) { return this.svc.pause(id, orgId); }
    getRuns(id, orgId) { return this.svc.getRuns(id, orgId); }
    getStats(id, orgId) { return this.svc.getStats(id, orgId); }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], AutomationController.prototype, "delete", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], AutomationController.prototype, "pause", null);
__decorate([
